#[cfg(test)]
mod tests {
    use cache_cleaner_daemon::hardware::uevent::{
        get_charger_state, get_screen_state, ChargerState, ScreenState, UeventMessage,
    };
    ...
    fn test_parse_power_supply_uevent() {
        ...
        assert_eq!(
            event.devpath,
            "/devices/platform/soc/1000000.pinctrl/power_supply/battery"
        );
        assert_eq!(
            event
                .properties
    ...
    fn test_parse_drm_graphics_uevent() {
        ...
        assert_eq!(
            event.devpath,
            "/devices/platform/soc/display-subsystem/drm/card0"
        );
    }
